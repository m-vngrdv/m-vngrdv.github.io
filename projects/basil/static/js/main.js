...
$('.video').on('click', function () {
  var media = $(this).find('.video__media');
  var id = parseMediaURL(media[0]);
  var link = $(this).children('.video__link');
  var button = $(this).find('.video__button');
...
$(document).ready(function () {
  var href = $('.videos__name--current').attr('href');
  var id = getCover(href);
...
function getCover(link) {
  var regEx = /(?:youtu\.be\/|youtube\.com(?:\/embed\/|\/v\/|\/watch\?v=|\/user\/\S+|\/ytscreeningroom\?v=|\/sandalsResorts#\w\/\w\/.*\/))([^\/&]{10,12})/;
  var id = link.match(regEx);
  return id[1];
}